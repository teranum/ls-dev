...
public class RealtimeEventArgs(string TrCode, string Key, IDictionary<string, object> RealtimeBody) : EventArgs
{
    ...
    public IDictionary<string, object> RealtimeBody { get; } = RealtimeBody;
}
