BEGIN_FUNCTION_MAP
	.Func,해외선물 주문체결내역 조회,CIDBQ01800,SERVICE=CIDBQ01800,headtype=B,CREATOR=이호섭,CREDATE=2022/04/21 14:13:30;
	BEGIN_DATA_MAP
	...
	begin
		...
		해외선물행사가격, AbrdFutsXrcPrc, AbrdFutsXrcPrc, double, 30.11;
		...
		해외파생체결종목코드, OvrsDrvtExecIsuCode, OvrsDrvtExecIsuCode, char, 30;
		체결종목명, ExecIsuNm, ExecIsuNm, char, 50;
		체결매매구분코드, ExecBnsTpCode, ExecBnsTpCode, char, 1;
		체결매매구분명, ExecBnsTpNm, ExecBnsTpNm, char, 10;
		해외선물체결가격, AbrdFutsExecPrc, AbrdFutsExecPrc, double, 30.11;
		체결수량, ExecQty, ExecQty, long, 16;
		주문조건가격, OrdCndiPrc, OrdCndiPrc, double, 30.11;
		...
		스프레드기준종목여부, SprdBaseIsuYn, SprdBaseIsuYn, char, 1;
		해외선물주문일자, OvrsFutsOrdDt, OvrsFutsOrdDt, char, 8;
		해외선물주문번호2, OvrsFutsOrdNo2, OvrsFutsOrdNo2, char, 10;
		해외선물원주문번호2, OvrsFutsOrgOrdNo2, OvrsFutsOrgOrdNo2, char, 10;
		해외파생종목코드2, OvrsDrvtIsuCode2, OvrsDrvtIsuCode2, char, 30;
	end
	END_DATA_MAP
END_FUNCTION_MAP
