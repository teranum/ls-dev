BEGIN_FUNCTION_MAP
	.Func,해외선물 주문체결내역 상세 조회,CIDBQ02400,SERVICE=CIDBQ02400,ENCRYPT,headtype=B,CREATOR=이호섭,CREDATE=2022/04/21 14:52:56;
	BEGIN_DATA_MAP
	...
	begin
		...
		주문발송일시, OrdSndDttm, OrdSndDttm, char, 17;
		체결일시, ExecDttm, ExecDttm, char, 17;
