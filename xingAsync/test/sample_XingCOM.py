################################################
# COM모드(XingCOM)를 이용한 국내주식/국내선물/해외선물/해외주식 샘플코드
# DLL모드와 이용방법 동일하게 사용가능
...
class MainWindow(QMainWindow, form_class):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("XingCOM Test")
        self.api = XingCOM()
    ...
    def on_login(self):
        ret = self.api.login(self.text_user_id.text(), self.text_user_pwd.text(), self.text_cert_pwd.text())
    ...
    def on_run(self):
        ...
        match sample:
            ...
            case "업종-마스터조회":
                response = api.request("t8424", {"gubun1": "0"})
            ...
            case "업종-기간별추이":
                ...
                response = api.request("t1514", inputs)
            ...
            case "업종-차트":
                ...
                response = api.request("t4203", inputs)

            case "투자정보-투자의견":
                response = api.request("t3401", "005930")

            case "투자정보-종목별 증시일정":
                response = api.request("t3202", "005930")

            case "투자정보-FNG_요약":
                response = api.request("t3320", "005930")
            ...
            case "투자정보-재무순위종합":
                ...
                response = api.request("t3341", inputs)

            case "국내주식-마스터-코스피":
                response = api.request("t9945", "1")

            case "국내주식-마스터-코스닥":
                response = api.request("t9945", "2")
            ...
            case "국내주식-현재가 시세메모":
                ...
                response = api.request("t1104", inputs)
            ...
            case "국내주식-멀티종목 현재가":
                ...
                response = api.request("t8407", inputs)
            ...
            case "국내주식-차트-분":
                ...
                response = api.request("t8412", inputs)
            ...
            case "국내주식-차트-일주월년":
                ...
                response = api.request("t8410", inputs)
            ...
            case "국내주식-차트-연속조회":
                ...
                if response.cont_yn: # 연속조회가능
                    ...
                    response = api.request("t8410", inputs, True)
            ...
            case "국내주식-조건리스트":
                ...
                if not hasattr(api, "cond_list"):
                    response = api.request("t1866", {"user_id": user_id, "gb":"0"}) # t1826: 종목Q클릭검색리스트
            ...
            case "국내주식-e종목검색":
                ...
                if hasattr(api, "cond_list"):
                    ...
                    response = api.request("t1857", ["0", "S", api.cond_list[0]["query_index"]])
            ...
            case "국내주식-예수금조회":
                ...
                response = api.request("CSPAQ22200", inputs)
            ...
            case "국내주식-잔고조회":
                ...
                response = api.request("t0424", inputs)
            ...
            case "국내주식-미체결조회":
                ...
                response = api.request("t0425", inputs)

            case "국내선물-마스터조회":
                inputs = {
                    "gubun": "0", # V:변동성지수선물, S:섹터지수선물, 그 이외의 값은 코스피200지수선물
                    }
                response = api.request("t8432", inputs)
            ...
            case "국내선물-옵션전광판":
                ...
                # ["202502", "M"] 미니 
                response = api.request("t2301", inputs)
            ...
            case "국내선물-차트-분":
                ...
                response = api.request("t8415", inputs)
            ...
            case "국내선물-예수금조회":
                ...
                response = api.request("CFOBQ10500", inputs)
            ...
            case "국내선물-잔고조회":
                ...
                response = api.request("t0441", inputs)
            ...
            case "국내선물-미체결조회":
                ...
                response = api.request("t0434", inputs)
            ...
            case "해외선물-마스터조회":
                ...
                response = api.request("o3121", inputs)

            case "해외선물-관심종목조회":
                # 해외선물시장 최근월물 조회
                response = api.request("o3101", "")
                ...
                response = api.request("o3127", indatas)
            ...
            case "해외선물-차트-분":
                ...
                response = api.request("o3123", inputs)
            ...
            case "해외선물-예수금조회":
                ...
                response = api.request("CIDBQ05300", inputs)
            ...
            case "해외선물-잔고조회":
                ...
                response = api.request("CIDBQ01500", inputs)
            ...
            case "해외선물-미체결조회":
                ...
                response = api.request("CIDBQ01800", inputs)
            ...
            case "해외주식-마스터조회":
                ...
                response = api.request("g3190", inputs)

            case "해외주식-종목정보":
                keysymbol = "82TSLA" # 82TSLA: 테슬라, 82AAPL: 애플
                response = api.request("g3104", ["R", keysymbol, keysymbol[:2], keysymbol[2:]])

            case "해외주식-현재가":
                keysymbol = "82TSLA" # 82TSLA: 테슬라, 82AAPL: 애플
                response = api.request("g3101", ["R", keysymbol, keysymbol[:2], keysymbol[2:]])
            ...
            case "해외주식-차트-분":
                ...
                response = api.request("g3203", inputs)
            ...
            case "해외주식-차트-일주월년":
                ...
                response = api.request("g3204", inputs)
            ...
            case "해외주식-예수금조회":
                ...
                response = api.request("COSOQ02701", inputs)
            ...
            case "해외주식-잔고조회":
                ...
                response = api.request("COSOQ00201", inputs)
            ...
            case "해외주식-미체결조회":
                ...
                response = api.request("COSAQ00102", inputs)
