// This file was auto generated by ComType Tool at 2025-01-26 오후 4:10:46
...
namespace LS.XACom
{
    ...
    internal interface _IXAQueryEvents
    {
        ...
        [DispId(1)]
        void ReceiveData([MarshalAs(UnmanagedType.BStr)] string szTrCode);

        [MethodImpl(MethodImplOptions.InternalCall | MethodImplOptions.PreserveSig, MethodCodeType = MethodCodeType.Runtime)]
        [DispId(2)]
        void ReceiveMessage(bool bIsSystemError, [MarshalAs(UnmanagedType.BStr)] string nMessageCode, [MarshalAs(UnmanagedType.BStr)] string szMessage);

        [MethodImpl(MethodImplOptions.InternalCall | MethodImplOptions.PreserveSig, MethodCodeType = MethodCodeType.Runtime)]
        [DispId(3)]
        void ReceiveChartRealData([MarshalAs(UnmanagedType.BStr)] string szTrCode);

        [MethodImpl(MethodImplOptions.InternalCall | MethodImplOptions.PreserveSig, MethodCodeType = MethodCodeType.Runtime)]
        [DispId(4)]
        void ReceiveSearchRealData([MarshalAs(UnmanagedType.BStr)] string szTrCode);
    ...
    internal interface _IXARealEvents
    {
        [MethodImpl(MethodImplOptions.InternalCall | MethodImplOptions.PreserveSig, MethodCodeType = MethodCodeType.Runtime)]
        [DispId(1)]
        void ReceiveRealData([MarshalAs(UnmanagedType.BStr)] string szTrCode);

        [MethodImpl(MethodImplOptions.InternalCall | MethodImplOptions.PreserveSig, MethodCodeType = MethodCodeType.Runtime)]
        [DispId(2)]
        void RecieveLinkData([MarshalAs(UnmanagedType.BStr)] string szLinkName, [MarshalAs(UnmanagedType.BStr)] string szData, [MarshalAs(UnmanagedType.BStr)] string szFiller);
    ...
    internal class XAQueryClassEventMulticaster(XAQueryClass parent) : _IXAQueryEvents
    {
        public void ReceiveData(string szTrCode) => parent.RaiseOnReceiveData(this, new(szTrCode));
        public void ReceiveMessage(bool bIsSystemError, string nMessageCode, string szMessage) => parent.RaiseOnReceiveMessage(this, new(bIsSystemError, nMessageCode, szMessage));
        public void ReceiveChartRealData(string szTrCode) => parent.RaiseOnReceiveChartRealData(this, new(szTrCode));
        public void ReceiveSearchRealData(string szTrCode) => parent.RaiseOnReceiveSearchRealData(this, new(szTrCode));
    }

    /// <summary>XAQueryClass</summary>
    [Guid("781520A9-4C8C-433B-AA6E-EE9E94108639")]
    public class XAQueryClass
    {
        // public const string PROGID = "XA_DataSet.XAQuery.1";

        private readonly IXAQuery com;
        ...
        internal void RaiseOnReceiveData(object sender, _IXAQueryEvents_ReceiveDataEventArgs e) => OnReceiveData?.Invoke(this, e);
        internal void RaiseOnReceiveMessage(object sender, _IXAQueryEvents_ReceiveMessageEventArgs e) => OnReceiveMessage?.Invoke(this, e);
        internal void RaiseOnReceiveChartRealData(object sender, _IXAQueryEvents_ReceiveChartRealDataEventArgs e) => OnReceiveChartRealData?.Invoke(this, e);
        internal void RaiseOnReceiveSearchRealData(object sender, _IXAQueryEvents_ReceiveSearchRealDataEventArgs e) => OnReceiveSearchRealData?.Invoke(this, e);
        ...
        public XAQueryClass()
        {
            try
            {
                ...
                if (pUnknown != null)
                {
                    ...
                    if (com != null)
                    {
                        Guid guidEvents = typeof(_IXAQueryEvents).GUID;
                        ...
                        {
                            XAQueryClassEventMulticaster pEventSink = new(this);
    ...
    [ClassInterface(ClassInterfaceType.None)]
    internal class XARealClassEventMulticaster(XARealClass parent) : _IXARealEvents
    {
        public void ReceiveRealData(string szTrCode) => parent.RaiseOnReceiveRealData(this, new(szTrCode));
        public void RecieveLinkData(string szLinkName, string szData, string szFiller) => parent.RaiseOnRecieveLinkData(this, new(szLinkName, szData, szFiller));
    }

    /// <summary>XARealClass</summary>
    [Guid("4D654021-F9D9-49F7-B2F9-6529A19746F7")]
    public class XARealClass
    {
        // public const string PROGID = "XA_DataSet.XAReal.1";

        private readonly IXAReal com;
        ...
        internal void RaiseOnReceiveRealData(object sender, _IXARealEvents_ReceiveRealDataEventArgs e) => OnReceiveRealData?.Invoke(this, e);
        internal void RaiseOnRecieveLinkData(object sender, _IXARealEvents_RecieveLinkDataEventArgs e) => OnRecieveLinkData?.Invoke(this, e);
        ...
        public XARealClass()
        {
            try
            {
                ...
                if (pUnknown != null)
                {
                    ...
                    if (com != null)
                    {
                        Guid guidEvents = typeof(_IXARealEvents).GUID;
                        var pConnectionPointContainer = (System.Runtime.InteropServices.ComTypes.IConnectionPointContainer)pUnknown;
                        pConnectionPointContainer.FindConnectionPoint(ref guidEvents, out _pConnectionPoint);
                        if (_pConnectionPoint != null)
                        {
                            XARealClassEventMulticaster pEventSink = new(this);
                            _pConnectionPoint.Advise(pEventSink, out int nCookie);
                            Created = true;
                        }
                    }
